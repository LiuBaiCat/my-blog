...
> [!IMPORTANT]
> **声明**：<mark>此页面所涉及的歌曲资源仅用于 HTML/CSS/JavaScript 前端技术学习与练习，无意侵犯任何版权。如有侵权，请联系删除。请勿用于任何商业用途。</mark>

<div style="color: red;font-weight: bold;">此页面所涉及的歌曲资源仅用于 HTML/CSS/JavaScript 前端技术学习与练习，无意侵犯任何版权。如有侵权，请联系删除。请勿用于任何商业用途。</div>
...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="本页面所涉及的歌曲资源仅用于前端技术学习与练习，无意侵犯任何版权。请勿用于任何商业用途。"
    />
    <style>
      * {
        margin: 0;
  ...
  <body>
    <audio controls src="./assets_duyi_3/世末歌者.mp3"></audio>
    <div class="container">
      <ul class="lyr-list">
        <!-- li*10>lorem3 -->
      </ul>
    ...
    <script>
      (async () => {
        ...
        const getLyric = async () => {
          try {
            const res = await fetch("./assets_duyi_3/世末歌者.lrc");
